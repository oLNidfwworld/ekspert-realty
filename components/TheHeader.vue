<template>
    <header class="header">
        <div class="header__inner">
          ...
          <TheNavigation/>
          <MainMenu/>
          <div class="flex items-center text-black font-bold small-header-line">
...
import ESearch from "~/components/Base/E-search.vue";
export default {
    components: {ESearch, Logo, TheNavigation, MainMenu },
    name: "TheHeader"
}
</script>
<style lang="postcss">
  ...
  .small-header-line>*:first-child{
    margin-left: 0px !important;
  }
  .header {
    @apply flex justify-center items-center text-white fixed w-full bg-white text-black border-grey;
    z-index: 89;
    border-bottom-width: 1px;
    height: 90px;
    &__inner{
       @apply flex justify-between items-center text-white container px-[7px];
     }
  }
</style>
