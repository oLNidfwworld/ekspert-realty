...
<template>
  <div class="grid gap-10 catalog-item__detail-wrapper">
    <div class="grid gap-10 catalog-item__detail">
      <div class="grid  ">
        <ClientOnly>
          <PictureDetailSlider sliderClasses="" :pictures="photos" />
        </ClientOnly>
      </div>
      <div>
        ...
        <ul class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 px-2 py-3 mb-2">
          <li class="flex flex-col"><span> </span><span class="font-bold"> </span></li>
        </ul>
    ...
    <p class="leading-[22px] text-[16px] font-[300]">Описание пока недоступно</p>

    <BargainingMap v-if="isMapAppear" ref="mapElement" :map-center="injected.mapCenter.value" :zoom="injected.zoom" :placements="injected.placements.value">
    </BargainingMap>
    ...
    <section>
      ...
      <div class="grid grid-cols-1 gap-5">
        <ClientOnly>
          <BargainingSimilars v-for="(similarItem, index) in pageContent" :product="similarItem" :key="index" />
...
<style scoped>
.share-appear-enter-active,
.share-appear-leave-active {
  transition: 0.4s;
}

.share-appear-enter-to,
.share-appear-leave-from {
  transform: translateY(0px);
  opacity: 1;
}

.share-appear-enter-from,
.share-appear-leave-to {
