...
<template>
  <div class="grid gap-10 catalog-item__detail-wrapper">
    <div class="grid gap-10 catalog-item__detail">
      ...
      <div>
        <h1 class="font-bold">Продажа земельных участков под ИЖС в мкр. Трубицыно Павлово-Посадского района</h1>
        <ClientOnly>
    ...
    <div>
      ...
      <h3 class="mb-2 sm:mb-5 text-[18px] sm:text-[24px] font-semibold text-center">Микрорайон Трубицыно ищет жильцов!</h3>
    <p class="text-[14px] sm:text-[18px] mb-3 sm:mb-6">Мечтаете жить в гармонии с природой и подальше от городского шума и суеты? 
      Но при этом не готовы отказываться от благ цивилизации? 
    </p>
    <h3 class="mb-2 sm:mb-5 text-[18px] sm:text-[24px] font-semibold text-center">Тогда микрорайон Трубицыно – это как раз то, что вам нужно!</h3>
    <p class="text-[14px] sm:text-[18px]">
      Это уникальное место для жизни, в котором удивительным образом сочетаются удачное расположение, близость к природе и развитая инфраструктура. <br>
      Расположенный всего в 500 м. от г. Павловский Посад, на опушке смешанного леса близ реки Ходца, он удивительным образом сочетает в себе все прелести загородной жизни и городской инфраструктуры. 
      <br>
      В настоящее время в микрорайоне построены внутриквартальные дороги и осуществляется подключение к электроснабжению.
      <br>
