      ...
      <div class="grid gap-10 catalog-item__detail">
        ...
        <div>
          ...
          <ul class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 px-2 py-3 mb-2">
            ...
            <li v-if="product.item.communications" v-for="(comm, commi) in product.item.communications"
              class="flex flex-col">
              <span>
                {{ comm.name }}
              </span>
          ...
          <div class="grid grid-cols-1 lg:grid-cols-[5fr_6fr] xl:grid-cols-[3fr_6fr] justify-between gap-3 lg:gap-[91px]">
            <div class="flex flex-col sm:flex-row md:flex-col flex-shirk flex-wrap grid-cols-1 gap-4 w-full mb-8">
              <ClientOnly>
                <Favorite class="btn-grey btn border-red text-red py-[8px] btn-grey sm:w-fit md:w-full btn-grey"
                  :enableText="true" :product-id="product.item.id" />
                ...
                <div class="relative">
                  ...
                  <transition name="share-appear">
                    <div v-if="isShareButtonActive"
                      ...
                      <Share :link="`https://t.me/share/url?url=${currUrl()}&text=${product.item.name}`"
                      ...
                      <Share :link="`http://vk.com/share.php?url=${currUrl()}&title=${product.item.name}`"
                      ...
                      <Share :link="`https://api.whatsapp.com/send?text=${product.item.name} ${currUrl()}`"
                      ...
                      <Share :link="`https://connect.ok.ru/offer?url=${currUrl()}&title=${product.item.name}`"
                      ...
                      <Share :link="`viber://forward?text=${product.item.name} ${currUrl()}&utm_source=share2`"
            ...
            <div class="bg-concrete grid grid-cols-1 font-semibold pt-2 md:w-full">
              ...
              <div class="flex flex-col justify-between px-5">
                ...
                <ClientOnly>
                  <e-input class="mb-2" mask="+{7} #00 000-00-00" v-model="myPhone" placeholder="+7(___) ___-__-__" />
                </ClientOnly>
              </div>
